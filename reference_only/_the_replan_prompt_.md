...
Start by reading the existing plan (`reference_only\curried-coalescing-manatee.md`) then create a new, fresh plan, with all of the additional information into account, to re-implement the kinetic-scheme-visualizer inspection module in the pyglotaran-extras.